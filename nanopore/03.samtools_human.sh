...
ref="/home/chen/jiangjing/00.db/hg38/hg38_trna_dataprocessing/hg38_rmdup_add.fa"
for i in *.fq.gz;do
       n=${i/.fq.gz/}
...
ref="/home/chen/jiangjing/00.db/hg38/hg38_trna_dataprocessing_mt/hg38-mature-tRNA-mt.fa"
for i in *.fq.gz;do
       n=${i/.fq.gz/}
       bwa mem -W13 -k6 -xont2d -T20 $ref ${n}.fq.gz |\
       samtools view -m80 -F4 -b - |\
...
mkdir 02.hg38_mt_80 03.hg38_80
mv *_mt.bam* *_trna_mt_stat.txt 02.hg38_mt_80
mv *.bam* *_trna_stat.txt 03.hg38_80
...
mkdir 04.hg38_mt_80_q0 05.hg38_80_q0 06.hg38_mt_80_q5 07.hg38_80_q5
mv *_mt_1.bam* *_trna_mt_stat_q0.txt 04.hg38_mt_80_q0
mv *_1.bam* *_trna_stat_q0.txt 05.hg38_80_q0
mv *_mt_5.bam* *_trna_mt_stat_q5.txt 06.hg38_mt_80_q5
mv *_5.bam* *_trna_stat_q5.txt 07.hg38_80_q5
