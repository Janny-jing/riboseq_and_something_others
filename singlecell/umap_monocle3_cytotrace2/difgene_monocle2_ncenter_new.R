...
outpath <- "difgene_monocle2_results_remove31_remove27_reclusterlow_800"
...
for (ncenter in ncenters) {
    ...
    cds_subset <- orderCells(cds_subset)
    # 构建文件名
    filename <- paste0(outpath, "/ncenter_", ncenter,  ".png")
    ...
    filename2 <- paste0(outpath, "/ncenter_", ncenter,"_facet.png")
