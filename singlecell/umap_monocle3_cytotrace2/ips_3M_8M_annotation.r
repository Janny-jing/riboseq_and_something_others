...
p <- DimPlot(ips,reduction = "umap", group.by = c("seurat_clusters","predicted.celltype"), label = TRUE, label.size = 3,repel = TRUE)
# 保存为 PNG 或 PDF 文件
ggsave("umap_test.png", plot = p, width = 20, height = 10, dpi = 300)
