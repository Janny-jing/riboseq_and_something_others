...
outpath <- "difgene_monocle2_results_remove31"
if (!dir.exists(outpath)) dir.create(outpath)
print(outpath)
obj <- readRDS("scanpy_UMAP_n_neighbors10_npcs23_mindist0.5_spread0.5_copy_remove31.rds")
...
# 参数列表
ncenters=seq(from = 100, to = 3000, by = 100)
