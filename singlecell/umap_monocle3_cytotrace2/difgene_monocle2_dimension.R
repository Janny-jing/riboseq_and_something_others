...
outpath <- "difgene_monocle2_dimension"
if (!dir.exists(outpath)) dir.create(outpath)
print(outpath)
obj <- readRDS("subset_new_umap_dim18_spread2.5_mindist0.7_celltypes_250630_remove27_recluster_low_terminal_removeundefined.rds")
...
Idents(obj) <- obj$human_celltypes_250702
...
for (dimension in dimensions) {
    ...
    root_cells <- row.names(subset(pData(cds_subset), human_celltypes_250702 == "Rgl1-like"))
