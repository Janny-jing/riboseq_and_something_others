...
outpath <- "low_high_difgene_monocle2_results_remove31_remove27_reclusterlow_ncenter_dimension"
if (!dir.exists(outpath)) dir.create(outpath)
print(outpath)
obj <- readRDS("subset_new_umap_dim18_spread2.5_mindist0.7_celltypes_250630_remove27_recluster_low.rds")
