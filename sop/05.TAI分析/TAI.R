...
# 使用函数并返回结果
result_data <- calculate_tAI(trna_file_path = "E:\\temp\\08.TAI\\ctl_r1.trna",
                             m_file_path = "E:\\temp\\08.TAI\\isg_codonM.m",
                             ffn_file_path = "E:\\temp\\08.TAI\\isg.fa")
write.csv(result_data, "./isg_wsncontrol_tAI.csv", row.names = F)
